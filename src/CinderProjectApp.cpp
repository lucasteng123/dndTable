...
void CinderProjectApp::updateWindowTitle()
{
	if( mUseBeginEnd )
...
CINDER_APP( CinderProjectApp, RendererGl( RendererGl::Options().msaa( 8 ) ), &CinderProjectApp::prepare )
